...
foreach($attach as $key=>$value):
	...
	$atturl = strpos($value['filepath'],"http")===false?BLOG_URL.substr($value['filepath'], 3):$value['filepath'];
	if ($extension == 'zip' || $extension == 'rar'){
		...
		$ed_imgpath = strpos($imgpath,"http")===false?BLOG_URL.substr($imgpath, 3):$imgpath;
